...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="images/img/jentafrica.png" >
    <title>Jentafrica</title>
    <!-- Bootstrap core CSS -->
...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/img/jentafrica.png" width="92" height="26"  alt=""> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/rubiscopy1.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery & Take-Out </h1>
                    <h5 class="font-white space-xs">Get your Orders </h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to order....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="I would like to order...."> </div>
                            </div>
                            <button onclick="location.href='restaurants.php'" type="button" class="btn theme-btn btn-lg">Search order</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose product</h4> </div>
                        <!-- end:Step -->
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Delivery or Ready</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Orders of the Month</h2>
                    <p class="lead">The easiest way to get anything from Rubis Rongai</p>
                </div>
                <div class="row">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with Gas Cylinders or liquor.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your order delivered! And enjoy! Pay online on pickup or delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/img/jentafrica.png"  alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                    ...
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Pay via credit card or on delivery</a> </li>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>RUBIS ONGATA RONGAI</p>
                            <h5>Phone: <a href="tel:+254707903355">+254707903355</a></h5> </div>
